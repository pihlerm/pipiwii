...
/*************************************************************************************************/
  /********************************  PID Controller *********************************/
    ...
    */
     ...
     * room for servo travel, then you must enable and set all three following options */
     #define SERVO_MIN  {1020, 1020, 1020, 1320, 1020, 1020, 1020, 1020}
     #define  SERVO_MAX {2000, 2000, 2000, 1750, 2000, 2000, 2000, 2000}
  ...
  /***********************          Heli                           ***********************/
    ...
    /*
            TRIKOPLAN options
    */
    // set this to front motor hover throttle value (1000-2000)
    #define TRIKOPLAN_MOTOR_HOVER 1500
    // critical pressure of minimum plane speed (0-1024)
    #define TRIKOPLAN_PRESSURE_CRTICAL 28.0  // cca 65 km/h!
    // boost front motors% 
...
/*************************************************************************************************/
  ...
  #define OVERRIDE_V_BATPIN                   A5 // instead of A3    // Analog PIN 3
...
/*************************************************************************************************/
  ...
  /******                Serial com speed    *********************************/
    ...
    #define SERIAL1_COM_SPEED 9600 // GPS
    #define SERIAL2_COM_SPEED 115200  // LOGGER
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_THROTTLE  (MINTHROTTLE + 500)    // (*) Throttle level used for landing - may be relative to MINTHROTTLE - as in this case
...
//    #define TELEMETRY_ALT_GPS         // send GPS based altitude (altitude above see level), for FLD-02 don't use together with TELEMETRY_ALT_BARO
  ...
  /********************************************************************/
    ...
    #define VBATLEVEL_WARN2 138 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT  136 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
...
/*************************************************************************************************/
  ...
  #define SERIALOG_D_GSPD      // log gps (ground) speed
  #define SERIALOG_D_ALT       // log altitude (baro)
  #define SERIALOG_D_ATT       // log attitude (calculated from ACC data) ATT_P;ATT_R;ATT_H
  #define SERIALOG_D_TKP_FI    // log fi angle (before PID correction)
  #define SERIALOG_D_TKP_FMOT  // log front motor power before PID correction
  #define SERIALOG_D_RC        // log RC commands RC_P;RC_R;RC_T;RC_Y
  #define SERIALOG_D_MOT       // log motor outputs MOT_1 .. MOT_N
  #define SERIALOG_D_SER       // log servo outputs SER_1 .. SER_N
...
// enable/disable
//#define BH_TUNE
// uncomment any hooks you're using in UserCode.
